...
import com.xtree.base.utils.MaterialDialogUtils;
...
public abstract class BaseFragment<V extends ViewDataBinding, VM extends BaseViewModel> extends RxFragment implements IBaseView {
    ...
    protected void initImmersionBar() {
        //设置共同沉浸式样式
        ImmersionBar.with(this).navigationBarColor(R.color.default_navigation_bar_color).fitsSystemWindows(true).statusBarDarkFont(true).init();
    }
