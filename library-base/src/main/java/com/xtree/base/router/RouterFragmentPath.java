...
public class RouterFragmentPath {
    ...
    public static class Mine {
        ...
        public static final String PAGER_BONUS_POOL = MINE + "/BonusPool";
        /**
         * 綁定谷歌动态口令
         */
        ...
        public static final String PAGER_COMMISSIONSREPORTS2 = MINE + "/CommissionsReports2"; //返水契约-佣金报表查看
        public static final String PAGER_LOTTERYDIVIDENDREPORTS = MINE + "/LotteryDividendReports"; //返水契约-彩票分红报表
        ...
        public static final String PAGER_MSG_LIST = MINE + "/MsgList";
