...
public class AttachDialog extends AttachPopupView {
    ...
    public AttachDialog(@NonNull Context context, String title, String msg, ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
    ...
    public AttachDialog(@NonNull Context context, String title, String msg, String txtLeft, String txtRight, ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
    ...
    public AttachDialog(@NonNull Context context, String title, CharSequence msg, boolean isSingleBtn, ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
    ...
    public AttachDialog(Context context, CharSequence title, CharSequence title2, CharSequence msg, String txtLeft, String txtRight, boolean isSingleBtn, ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.title2 = title2;
        this.msg = msg;
