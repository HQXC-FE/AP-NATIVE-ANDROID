...
/**
 * 基础弹窗 左侧取消按钮【白色】 右侧确认【蓝色】
 */
public class BaseDialog  extends CenterPopupView {
    ...
    boolean isSingleBtn;
    String txtRight;
    BaseDialog.ICallBack mCallBack;
    ...
    public BaseDialog(@NonNull Context context, String title, String msg, BaseDialog.ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
    ...
    public BaseDialog(@NonNull Context context, String title, String msg, String txtLeft, String txtRight, BaseDialog.ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
    ...
    public BaseDialog(@NonNull Context context, String title, String msg, boolean isSingleBtn, BaseDialog.ICallBack mCallBack) {
        super(context);
        this.title = title;
        this.msg = msg;
