...
public class WebAppInterface {
    ...
    public void goApp(String type, JsParameterVo vo) {
        ...
        switch (type) {
            ...
            case TYPE_VIP:
                if (isLogin) {
                    BrowserActivityX5.start(context, context.getString(R.string.txt_vip_center),
            ...
            case TYPE_ACTIVITY_DETAIL:
                ...
                mView.post(() -> {
                    ...
                    new XPopup.Builder(context).moveUpToKeyboard(false).asCustom(BrowserDialogX5.newInstance(context, url)).show();
                });
