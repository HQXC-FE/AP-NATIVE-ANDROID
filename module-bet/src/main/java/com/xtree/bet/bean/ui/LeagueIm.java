...
public class LeagueIm implements League{
    ...
    public LeagueIm(LeagueInfo leagueInfo){
    ...
    public static final Creator<LeagueIm> CREATOR = new Creator<LeagueIm>() {
        @Override
        public LeagueIm createFromParcel(Parcel source) {
            return new LeagueIm(source);
        }

        @Override
        public LeagueIm[] newArray(int size) {
