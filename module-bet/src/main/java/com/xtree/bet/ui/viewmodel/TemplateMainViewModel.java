        ...
        Disposable disposable = (Disposable) model.getBaseApiService().getSettings(map)
                ...
                .subscribeWith(new HttpCallBack<HotLeagueInfo>() {
                    ...
                    public void onResult(HotLeagueInfo hotLeagueInfo) {
                        List<String> hotLeagues =
                                !TextUtils.equals(platform, PLATFORM_PM) && !TextUtils.equals(platform, PLATFORM_PMXC) ?
                                        hotLeagueInfo.fbxc_popular_leagues : hotLeagueInfo.obg_popular_leagues;
