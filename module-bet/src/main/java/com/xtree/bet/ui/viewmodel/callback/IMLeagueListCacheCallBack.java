...
public class IMLeagueListCacheCallBack extends HttpCallBack<MatchLeagueListCacheRsp> {
    ...
    public IMLeagueListCacheCallBack(ImMainViewModel viewModel, boolean hasCache, boolean isTimerRefresh, boolean isRefresh,
