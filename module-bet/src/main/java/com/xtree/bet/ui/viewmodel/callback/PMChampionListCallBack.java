...
public class PMChampionListCallBack extends HttpCallBack<MatchListRsp> {
    ...
    public PMChampionListCallBack(PMMainViewModel viewModel,int sportPos, String sportId, int orderBy, List<Long> leagueIds, List<Long> matchids, int playMethodType, int oddType, boolean isTimerRefresh, boolean isRefresh,int currentPage) {
    ...
    public void onResult(MatchListRsp matchListRsp) {
        ...
        mViewModel.mChampionMatchInfoList.addAll(matchListRsp.data);
