...
public class FbDataView extends BaseDetailDataView implements View.OnClickListener {
    ...
    public void setMatch(Match match, boolean isMatchList){
        ...
        List<Integer> scoreYellowCard = match.getScore(String.valueOf(IMConstants.SCORE_TYPE_YELLOW_CARD));
        ...
        List<Integer> scoreRedCard = match.getScore(String.valueOf(IMConstants.SCORE_TYPE_RED_CARD));
        ...
        List<Integer> scoreCornor = match.getScore(String.valueOf(IMConstants.SCORE_TYPE_CORNER));
