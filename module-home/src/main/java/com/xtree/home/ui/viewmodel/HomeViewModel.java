...
public class HomeViewModel extends BaseViewModel<HomeRepository> {
    ...
    public void getSettings() {
        HashMap<String, String> map = new HashMap();
        map.put("fields", "op_hichat_url_suffix,customer_service_url,public_key,barrage_api_url," + "x9_customer_service_url," + "promption_code,default_promption_code,ws_check_interval,ws_retry_number,ws_retry_waiting_time,ws_expire_time,app_response_speed_calculation,app_response_speed_max");
