...
public class LiveRoomInfoBean {
    ...
    private int mars_match_id;
    private int mars_live_id;
    private int mars_game_id;
    private int game_id;
    ...
    public String getPull_tc() {
        return pull_tc;
    }

    public void setPull_tc(String pullTc) {
        this.pull_tc = pullTc;
    }
    ...
    public int getMars_match_id() {
        return mars_match_id;
    }

    public void setMars_match_id(int mars_match_id) {
        this.mars_match_id = mars_match_id;
    }

    public int getMars_live_id() {
        return mars_live_id;
    }

    public void setMars_live_id(int mars_live_id) {
        this.mars_live_id = mars_live_id;
    }

    public int getMars_game_id() {
        return mars_game_id;
    }

    public void setMars_game_id(int mars_game_id) {
        this.mars_game_id = mars_game_id;
    }
