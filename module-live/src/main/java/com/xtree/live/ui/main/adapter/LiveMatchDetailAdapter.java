...
public class LiveMatchDetailAdapter extends AnimatedExpandableListViewMax.AnimatedExpandableListAdapter {
    private List<PlayType> mDatas;
    private Match match;
    private Context mContext;

    public LiveMatchDetailAdapter(Context context, Match match, List<PlayType> datas) {
        this.mDatas = datas;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        ...
        GroupHolder holder;
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.live_bt_fb_detail_item_play_type_group, null);
        ...
        binding.rlPlayMethod.setBackgroundResource(Color.TRANSPARENT);
//        binding.rlPlayMethod.setBackgroundResource(isExpanded ? R.drawable.bt_bg_expand_group : R.drawable.bt_bg_expand_group_collapse);
    ...
    public View getRealChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.live_bt_fb_detail_item_play_type_child, null);
        ...
        LiveOptionAdapter optionAdapter = new LiveOptionAdapter(mContext, match, (PlayType) getGroup(groupPosition), optionList, optionList.getOptionList());
