...
import com.xtree.bet.ui.adapter.BaseAdapter;
...
public class LiveOptionAdapter extends BaseAdapter<Option> {
    private Match match;
    private PlayType playType;
    private OptionList optionList;

    public LiveOptionAdapter(Context context, Match match, PlayType playType, OptionList optionList, List<Option> datas) {
        super(context, datas);
    ...
    @Override
    public int layoutId() {
        return R.layout.live_bt_fb_list_item_play_type_item_option;
    }
