...
public class LiveFloatingWindows extends FloatingWindows {

    private static LiveFloatingWindows INSTANCE;
    private LiveFloatingWindows.ICallBack mICallBack;
    ...
    public static LiveFloatingWindows getInstance(Context context, LiveFloatingWindows.ICallBack callBack) {
        if (INSTANCE == null) {
            INSTANCE = new LiveFloatingWindows(context, callBack);
        }
        return INSTANCE;
    }

    public LiveFloatingWindows(Context context, LiveFloatingWindows.ICallBack callBack) {
        super(context);
    ...
    public void initData() {
        ...
        cbAgent.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (!isAgentCheck && !TextUtils.equals(mPlatform, PLATFORM_PM) && !TextUtils.equals(mPlatform, PLATFORM_PMXC)) {
...
//                }
        ...
        if (!isAgent && !TextUtils.equals(mPlatform, PLATFORM_PM) && !TextUtils.equals(mPlatform, PLATFORM_PMXC)) {
            nsvAgent.setVisibility(VISIBLE);
            rvAgent.setLayoutManager(new LinearLayoutManager(mContext));
//            if (TextUtils.equals(mPlatform, PLATFORM_FBXC)) {
//                rvAgent.setAdapter(new BtDomainAdapter(mContext, BtDomainUtil.getFbxcDomainUrl(), mICallBack, cbAgent));
