...
public class LiveWebSocketViewModel extends BaseViewModel<LiveRepository> {
    ...
    public LiveWebSocketViewModel(@NonNull Application application) {
        super(application);
    }

    public LiveWebSocketViewModel(@NonNull Application application, LiveRepository model) {
        super(application, model);
    }

//    public void getWsToken() {
//        Disposable disposable = (Disposable) model.getWebsocket()
