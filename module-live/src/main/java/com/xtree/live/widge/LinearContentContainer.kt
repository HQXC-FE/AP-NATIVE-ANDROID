...
import com.xtree.live.inter.ContentContainerImpl
import com.xtree.live.inter.ContentScrollMeasurer
import com.xtree.live.inter.IContentContainer
import com.xtree.live.inter.IInputAction
import com.xtree.live.inter.IResetAction
...
class LinearContentContainer : LinearLayout, IContentContainer {
    ...
    private fun initView(attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        val typedArray = context.obtainStyledAttributes(attrs, com.xtree.live.R.styleable.LinearContentContainer, defStyleAttr, 0)
        editTextId = typedArray.getResourceId(com.xtree.live.R.styleable.LinearContentContainer_edit_view, -1)
        autoResetId = typedArray.getResourceId(com.xtree.live.R.styleable.LinearContentContainer_auto_reset_area, -1)
        autoResetByOnTouch = typedArray.getBoolean(com.xtree.live.R.styleable.LinearContentContainer_auto_reset_enable, autoResetByOnTouch)
        typedArray.recycle()
