...
class PanelView : FrameLayout, IPanelView {
    ...
    private fun initView(attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        val typedArray = context.obtainStyledAttributes(attrs, com.xtree.live.R.styleable.PanelView, defStyleAttr, 0)
        panelLayoutId = typedArray.getResourceId(com.xtree.live.R.styleable.PanelView_panel_layout, -1)
        triggerViewId = typedArray.getResourceId(com.xtree.live.R.styleable.PanelView_panel_trigger, -1)
        isToggle = typedArray.getBoolean(com.xtree.live.R.styleable.PanelView_panel_toggle, isToggle)
        typedArray.recycle()
    }
