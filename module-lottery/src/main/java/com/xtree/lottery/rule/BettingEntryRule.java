...
public class BettingEntryRule {
    ...
    public interface ICallback {
        void onResult(List<RulesEntryData.SubmitDTO> result);
    }
    ...
    public void startEngine(RulesEntryData rulesEntryData, ICallback callback) {
        new Thread(() -> {
            facts = new Facts();
            ...
            callback.onResult(submitDTOList);
        }).start();
    }
