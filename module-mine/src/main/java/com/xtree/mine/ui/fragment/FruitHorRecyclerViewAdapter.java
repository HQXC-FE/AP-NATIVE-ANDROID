...
public class FruitHorRecyclerViewAdapter extends RecyclerView.Adapter {
    ...
    private ArrayList<WithdrawalListVo> bankWithdrawalList;
    private IFruitHorCallback callback;

    public FruitHorRecyclerViewAdapter(Context context, ArrayList<WithdrawalListVo> bankWithdrawalList, IFruitHorCallback callback) {
        super();
        this.context = context;
        this.bankWithdrawalList = bankWithdrawalList;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.showLayout.setOnClickListener(v -> {
            ...
            if (callback != null) {
                callback.callbackWithFruitHor(bankWithdrawalList.get(position));
            }
    ...
    public int getItemCount() {
        return this.bankWithdrawalList.size();
    }
