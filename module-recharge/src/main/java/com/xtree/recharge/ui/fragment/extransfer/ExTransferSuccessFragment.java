...
import com.xtree.recharge.databinding.FragmentExtransferSuccessBinding;
...
/**
 * Created by KAKA on 2024/7/30.
 * Describe: 极速转账-成功
 */
@Route(path = RouterFragmentPath.Transfer.PAGER_TRANSFER_EX_SUCCESS)
public class ExTransferSuccessFragment extends BaseFragment<FragmentExtransferSuccessBinding, ExTransferViewModel> {
